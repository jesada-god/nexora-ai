...
export function ChartPanel({ symbol, active, technicalIndicatorsEnabled }: { symbol: string; active: boolean; technicalIndicatorsEnabled: boolean }) {
